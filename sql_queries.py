...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs \
    (song_id varchar PRIMARY KEY, title varchar, artist_id varchar, year smallint, duration real)
""")

artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists \
    (artist_id varchar PRIMARY KEY, name varchar, location text, latitude real, longitude real)
""")
